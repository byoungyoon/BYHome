...
<head>
<meta charset="UTF-8">
<title>dept_manager.jsp</title>
<%
	/*
		데이터 베이스 employees의 테이블인 dept_manager를 추출한 것
		post방식으로 한번 만들어 보았다
	*/
%>
</head>
<body>
	<%
		...
		String sql = "SELECT * FROM dept_manager ORDER BY emp_no LIMIT ?, ?";
		PreparedStatement stmt = conn.prepareStatement(sql);
		String sql2 = "SELECT COUNT(*) as cot FROM dept_manager";
	...
	<form method="post" action="./dept_manager.jsp">
		<table border="1">
			<thead>
				<tr>
					<th>dept_no</th>
