...
<head>
<meta charset="UTF-8">
<title>emplyees.jsp</title>
<%
	/*
		데이터 베이스 employees의 테이블인employees를 추출한 것
		post방식으로 한번 만들어 보았다
	*/
%>
</head>
<body>
	<%
		...
		String sql = "SELECT * FROM employees ORDER BY emp_no LIMIT ?, ?";
		PreparedStatement stmt = conn.prepareStatement(sql);
		String sql2 = "SELECT COUNT(*) as cot FROM employees";
	...
	<form method="post" action="./emplyees.jsp">
		<table border="1">
			<thead>
				<tr>
					<th>emp_no</th>
